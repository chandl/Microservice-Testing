...
create table T_PLAYER (id bigint generated by default as identity (START WITH 1, INCREMENT BY 1) NOT NULL primary key, heart_count integer,
                        next_heart_time timestamp,
